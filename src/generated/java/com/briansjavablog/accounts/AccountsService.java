 ...
 * 2020-07-23T12:15:46.210+03:00
 * Generated source version: 3.3.7
 *
 */
@WebServiceClient(name = "AccountsService",
                  wsdlLocation = "file:/C:/Users/DErmoshin/IdeaProjects/contract/soap-service/src/main/resources/wsdl/Accounts.wsdl",
...
public class AccountsService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/DErmoshin/IdeaProjects/contract/soap-service/src/main/resources/wsdl/Accounts.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(AccountsService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/DErmoshin/IdeaProjects/contract/soap-service/src/main/resources/wsdl/Accounts.wsdl");
        }
        WSDL_LOCATION = url;
    }
